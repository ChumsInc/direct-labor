        ...
        <div>
            ...
            <form onSubmit={onSubmit}>
                ...
                <FormColumn label="Last Updated" width={9}>
                    {!!current.timestamp &&
                        <small className="text-secondary">{new Date(current.timestamp).toLocaleString()}</small>}
                </FormColumn>
                ...
                <div className="row g-3 mt-3">
                    ...
                    <div className="col-auto">
                        <SpinnerButton type="button" color="danger"
                                       disabled={loading || saving || !!steps.length || !current.id} size="sm"
